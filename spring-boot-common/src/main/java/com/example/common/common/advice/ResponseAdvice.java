...
import com.example.common.common.exception.BizException;
import com.example.common.common.model.Result;
import com.example.common.common.util.ResultUtils;
...
public class ResponseAdvice implements ResponseBodyAdvice {
	...
	public Result<?> methodArgumentNotValidExceptionExceptionHandler(HttpServletRequest request,
		...
		return ResultUtils.INSTANCE
				.getFailResult(methodArgumentNotValidException.getBindingResult(), result);
	}
