package com.example.hive2es.hive.config;
...
public class JdbcUtils {
     ...
     * 默认使用<default-config>里的配置 ,这里使用配置 hive-config.xml
     */
    private static DataSource ds = new ComboPooledDataSource("hive-config");
