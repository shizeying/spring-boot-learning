 ...
 * @author shizeying
 * @version 1.0.0
 * @desc {@link  MongoTemplate} MongoTemplate的操作类
 * @date 2020/11/04
 */
@Slf4j
@Component
...
public class MongodbUtil {
	 ...
	 * @return
	 */
	public static Object findDesignField(List<String> fields, Map<String, Object> map, Class<?> clazz,
	 ...
	 * @return
	 */
	public static Object findLikeByParam(String param, String collName, String sortField,
			Sort.Direction direction, Class<?> clazz) {
	 ...
	 * @return
	 */
	public static List<? extends Object> findSortByParam(Object obj, String collName,
	 ...
	 * @return
	 */
	public static List<? extends Object> findRangeByParam(Object obj, String collName,
		...
		Query query = new Query().addCriteria(rangeCriteria).addCriteria(criteria)
				.with(Sort.by(direction, sortField));
		return mongodbUtil.mongoTemplate.find(query, obj.getClass(), collName);
	}
	 ...
	 * @return
	 */
	public static Object findSortFirst(Class<?> entiy, Map<String, Object> map, String collectionName,
	 ...
	 */
	public static void updateMulti(String accordingKey, Object accordingValue,
			Map<String, Object> map,
	 ...
	 */
	public static Object findSum(Class<?> clazz, Map<String, Object> map, String collName,
			String sumField, Criteria rangeCriteria) {
		if (map.containsKey(null)) {
			return "查询条件key不能为Null";
		}
		Criteria criteria = null;
		...
		return mongodbUtil.mongoTemplate
				.aggregate(Aggregation.newAggregation(match, count), collName, clazz).getMappedResults();
	}
	 ...
	 * @return
	 */
	public static PageResult findSortPageCondition(Class<?> entiy, String collName,
			Map<String, Object> map,
		...
		PageResult pageModel = new PageResult();
