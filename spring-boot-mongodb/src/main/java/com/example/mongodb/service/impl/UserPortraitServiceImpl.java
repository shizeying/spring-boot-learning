...
public class UserPortraitServiceImpl implements UserPortraitService {
	...
	public List<UserPortraitEntity> batchAdd(
		...
		Function3<Long, String, String, UserPortraitEntity> function3 =
				(ei, un, db) -> new UserPortraitEntity()
						.setEntityId(ei)
						.setUsername(un)
						.setDatabaseName(db)
						.setInsertTime(LocalDateTime.now())
						.setUpdateTime(LocalDateTime.now());
		Function2<String, UserPortraitEntity, UserPortraitEntity> function2 =
