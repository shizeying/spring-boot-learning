...
public class GeneralBuild implements Serializable {
	...
	/** 是粗糙的类型 0：实体；1：分词*/
	private Integer isCoarseType = 1;
	/** 是粗 */
	private Boolean isCoarse = true;
	/** 细粒度类型 */
	private Boolean isFine = true;
	/** 细粒度类型： 0：实体；1：分词 */
	private Integer isFineType = 1;
	/** 细粒度类型 0：实体；1：分词*/
	private Integer isFineGrained = 1;
	/** 高亮 */
	private Boolean isHighlight = true;
	private List<String> columnItem = Lists.newArrayList();
	private AggregationsBuilder aggregations = new AggregationsBuilder();
